...
namespace ITMLib
{
	...
	*/
	...
	public:
		...
		void ProcessFrame(const ITMView *view, const ITMTrackingState *trackingState, ITMScene<TVoxel,TIndex> *scene, std::set< Vector3i >& possibleVoxels, ITMRenderState *renderState_live, bool resetVisibleList = false);
