...
namespace ITMLib
{
	...
	public:
		void MeshScene(ITMMesh *mesh, const ITMScene<TVoxel, ITMVoxelBlockHash> *scene, std::vector<ITMHashEntry>& hashEntries);
	...
	{
	public:
		void MeshScene(ITMMesh *mesh, const ITMScene<TVoxel, ITMPlainVoxelArray> *scene, std::vector<ITMHashEntry>& hashEntries);
